...
// Sample 20 transactions for testing
$transactions = [];
for ($i = 1; $i <= 20; $i++) {
    $transactions[] = [
        'name' => "Transaction #$i",
...
<!-- [ Main Content ] -->
<div class="pc-container ml-64 transition-all duration-300">
  <div class="pc-content">
    ...
    <div class="flex flex-col md:flex-row gap-6">
      ...
      <!-- LEFT: Profile Info -->
      <div class="bg-white p-6 rounded-xl shadow w-[700px] dark:bg-gray-800">
        <div class="p-6" x-data="{
          ...
          <div class="flex items-center space-x-6">
            <div class="relative inline-block">
              <img :src="avatar" class="w-28 h-28 rounded-full border-4 border-indigo-200 shadow dark:border-gray-600" alt="User Avatar">
            ...
            <div>
              <h2 class="text-3xl font-extrabold text-indigo-700 dark:text-white" x-text="username"></h2>
              <p class="text-lg text-gray-500 dark:text-gray-300 mt-1" x-text="fullname"></p>
            </div>
          </div>
