...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div class="pc-content">
      ...
      <section class="mt-8 px-4 md:px-8 lg:px-12">
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-8 max-w-5xl mx-auto">
          <h3 class="text-2xl font-semibold mb-4 text-center text-gray-900 dark:text-gray-100">Monthly Summary</h3>
      ...
      <section class="relative px-2 py-6">
        ...
        <div class="relative">
          ...
          <button id="wallet-right" class="absolute top-1/2 -translate-y-1/2 z-10 bg-gray-200 dark:bg-gray-700 hover:bg-indigo-600 hover:text-white w-10 h-10 flex items-center justify-center rounded-full shadow-md hidden" style="right: -10px;">&gt;</button>
        </div>
      </section>
      ...
      <section class="relative px-2 py-6">
        ...
        <div class="relative">
          ...
          <button id="cat-right" class="absolute top-1/2 -translate-y-1/2 z-10 bg-gray-200 dark:bg-gray-700 hover:bg-indigo-600 hover:text-white w-10 h-10 flex items-center justify-center rounded-full shadow-md hidden" style="right: -10px;">&gt;</button>
        </div>
      </section>
  ...
  <script>
    ...
    const categoryColors = {
      'Food': 'rgba(153, 102, 255, 0.8)',
      'Utilities': 'rgba(255, 99, 132, 0.8)',
      'Transportation': 'rgba(54, 162, 235, 0.8)',
      'Equipment': 'rgba(255, 205, 86, 0.8)',
