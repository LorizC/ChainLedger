        ...
        <div class="page-block">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="../admin/archvdtransactions.php" class="hover:text-blue-500 transition">Archives</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="col-span-12">
          <div class="card">
            ...
            <div class="card-body overflow-x-auto">
              ...
              <form method="GET" 
                    class="mb-4 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg shadow flex flex-wrap items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <select name="user" id="user"
                          class="border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-1.5 bg-white 
                                 dark:bg-gray-900 text-gray-700 dark:text-gray-100 focus:ring-2 
                ...
                <div class="flex items-center gap-1">
                  ...
                  <select name="merchant" id="merchant"
                    ...
                    <?php foreach ($merchants as $merchant): ?>
                      <option value="<?= $merchant ?>" <?= $filterMerchant === $merchant ? 'selected' : '' ?>>
                        <?= $merchant ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                  ...
                  <?php else: ?>
                    <?php foreach ($paginatedLedger as $row): ?>
                      <tr>
                        ...
                        <td class="max-w-[180px] truncate" title="<?= htmlspecialchars($row['user']) ?>">
              ...
              <?php if ($totalPages > 1): ?>
                <div class="mt-4 flex justify-center space-x-2">
                  ...
                  <?php
                    ...
                    if ($end < $totalPages) {
                      if ($end < $totalPages - 1) echo '<span class="px-2 text-gray-500 dark:text-gray-400">…</span>';
