...
<head>
  <title>ChainLedger | Account Registration</title>
  <meta charset="utf-8" />
...
<div class="pc-container">
  <div class="pc-content">
    <div class="page-header mb-4">
      <div class="page-block">
        <div class="page-header-title">
          <h5 class="mb-0 font-medium">Register Your Account</h5>
        </div>
        <ul class="breadcrumb">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
      ...
      <!-- RIGHT: Password Form -->
      <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
        <h2 class="text-2xl font-bold text-indigo-700 dark:text-indigo-400 mb-6">Business Account Registration</h2>
...
<form x-data="{showCurrent:false, showNew:false, showConfirm:false, confirmModal:false}"
  ...
  <!-- Current Password -->
  <div>
    <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Business ID</label>
    <div class="relative">
      <input :type="showCurrent ? 'text' : 'password'" name="business_id" required
             ...
             placeholder="Enter Business ID you want to register on">
    ...
    <!-- Password -->
    <div>
      <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Business Password</label>
      <div class="relative">
    ...
    <!-- Confirm Password -->
    <div>
      <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Confirm Business Password</label>
      <div class="relative">
  ...
  <div x-show="confirmModal" x-cloak
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-sm w-full p-6">
      <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Confirm Registration</h2>
      <p class="text-gray-700 dark:text-gray-300 mb-6">Are you sure you want to register your account with this business?</p>
      <div class="flex justify-end gap-3">
        ...
        <button type="button" @click="$refs.passwordForm.submit()"
