...
<nav class="pc-sidebar bg-primary-700 text-white min-h-screen w-[var(--tw-sidebar-width,264px)]">
  <div class="navbar-wrapper">
    ...
    <div class="m-header flex items-center py-5 px-6 h-header-height border-b border-gray-700/30">
      <a href="../staffs/dashboard.php" class="b-brand flex items-center gap-3">
...
<div class="flex flex-col items-center justify-center mb-6 px-2">
  ...
  />
      ...
      <ul class="pc-navbar space-y-1">
        ...
        <li class="pc-item">
          <a href="../staffs/dashboard.php" class="pc-link">
        ...
        <li class="pc-item">
          <a href="../staffs/ledger.php" class="pc-link">
        ...
        <li class="pc-item">
          <a href="../staffs/report.php" class="pc-link">
        ...
        <li class="pc-item">
          <a href="../staffs/analytics.php" class="pc-link">
        ...
        <li class="pc-item">
          <a href="../staffs/profile.php" class="pc-link">
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../staffs/editpassword.php">Edit Password</a></li>
            <li class="pc-item"><a class="pc-link" href="../staffs/deleteaccount.php">Delete Account</a></li>
          </ul>
        </li>
