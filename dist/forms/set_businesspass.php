<?php include('../handlers/set_businesspass.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <title>Set Password - ChainLedger</title>
      ...
      <div class="form-section">
        <?php if (!empty($businessname)): ?>
          <div class="success-message global-banner">
            Welcome, <?= htmlspecialchars($businessname) ?>! <br>
        ...
        <div class="inFormBackground">
          <div class="inLoginForm">
            ...
            <form method="post" action="">
              <div class="title">
                <h3 class="login-title">Set Business Password</h3>
              </div>
              ...
              <div class="button-container">
                <button type="submit" class="submitForm">Create Business Account</button>
