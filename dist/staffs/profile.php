        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow 
          ...
          <div class="flex items-center space-x-6">
            <div class="relative inline-block">
              <img :src="avatar"
                   class="w-32 h-32 rounded-full border-4 border-indigo-200 shadow dark:border-gray-600"
                   alt="User Avatar">
            ...
            <div class="max-w-[250px]">
              <h2 class="text-4xl font-extrabold text-indigo-700 dark:text-white truncate"
                  x-text="username"
                  :title="username"></h2>
              <p class="text-xl text-gray-500 dark:text-gray-300 mt-1 truncate"
                 x-text="fullname"
                 :title="fullname"></p>
            </div>
          </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 w-[28rem] dark:bg-gray-800">
              ...
              <form method="POST" action="profile.php">
                <div class="flex justify-center mb-4">
                  <img :src="avatar"
                       class="w-28 h-28 rounded-full border-4 border-indigo-200 shadow object-cover dark:border-gray-600"
                       alt="Avatar">
                </div>
                ...
                <div class="grid grid-cols-5 gap-4 mb-6">
                  <template x-for="a in [
                    '../assets/images/user/male1.jpg',
                    '../assets/images/user/male2.jpg',
                    '../assets/images/user/male3.jpg',
                    '../assets/images/user/female1.jpg',
                    '../assets/images/user/female2.jpg',
                    '../assets/images/user/female3.jpg'
                  ]" :key="a">
