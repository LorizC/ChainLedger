...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
          ...
          <div class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-4 rounded-lg text-gray-700 dark:text-gray-300 text-sm space-y-2">
            <p class="font-semibold mb-1">Deletion Guidelines:</p>
        ...
        <div 
          class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow flex-1"
          x-data="{
            confirmModal:false,
            showPassword:false,
            showConfirm:false,
        ...
        >
          ...
          <form 
            ...
            id="deleteForm" 
            method="POST" 
            action="/ChainLedger/dist/staffs/handlers/delete_account.php" 
            class="space-y-6"
          >
            <!-- Security Answer -->
            <div>
  ...
  <!-- Trigger confirmation modal on Enter key -->
  <script>
